...
import { lists1 } from "../../static";

const Portfolio = () => {
  const product1 = lists1.map((e, inx) => (
    <div
      key={inx}
    ...
    >
      ...
      >
        ...
        <a
          className="text-black text-lg items-center flex opacity-1 lg:opacity-0 gap-x-1 bg-sky-400 px-4 py-1 border hover:border-black hover:bg-transparent"
          target="_blank"
          key={inx}
          href={e.link}
        >
