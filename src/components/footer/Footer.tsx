...
const Footer = () => {
  return (
    <footer className="pb-20 pt-[250px] bg-[#1d2b3a] relative border-t">
      <p className="text-[200px] text-skills z-10 text-slate-800 font-semibold absolute top-[-60px] pointer-events-none left-[70px]">
        The End
      </p>
      <div className="mx-auto container z-30">
        <div className="flex flex-col items-center gap-y-20">
          <p className="text-6xl text-neutral-400 z-30">FOLLOW ME</p>
